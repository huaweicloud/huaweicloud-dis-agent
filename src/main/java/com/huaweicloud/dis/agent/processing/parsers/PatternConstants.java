...
public class PatternConstants
{
    ...
    public static final String APACHEERRORLOGTIMESTAMP =
        "(?:" + DAY + "\\s+" + MONTH + "\\s+" + MONTHDAY + "\\s+" + TIME + "\\s+" + YEAR + ")";
    
    public static final String SYSLOGTIMESTAMP = "(?:" + MONTH + "\\s+" + MONTHDAY + "\\s+" + TIME + ")";
    
    public static final String RFC3339 =
    ...
    public static final String COMMON_APACHE_LOG = "^(" + IPORHOST + ") " + "(" + USER + ") " + "(" + USER + ") "
        + "\\[(" + HTTPDATE + ")\\] " + "\"(" + NOQUOTE + ")\" " + "(" + INT + "|\\-) " + "(" + INT + "|\\-)";
    
    public static final String COMBINED_APACHE_LOG =
        COMMON_APACHE_LOG + " " + "\"(" + NOQUOTE + ")\" " + "\"(" + NOQUOTE + ")\"";
    
    public static final String APACHE_ERROR_LOG = "^\\[(" + APACHEERRORLOGTIMESTAMP + ")\\] " + "\\[(?:(" + WORD
        + "):)?(" + WORD + ")\\] " + "\\[pid (" + NONNEGINT + ")(?::tid (" + NONNEGINT + "))?\\] " + "\\[client ("
        + URIHOST + ")\\] " + "(" + ANYDATA + ")";
    
    public static final String SYSLOG_BASE = "^(" + SYSLOGTIMESTAMP + ") " + "(?:" + SYSLOGFACILITY + " )?" + "(" + USER
        + ") " + SYSLOGPROG + ": " + "(" + ANYDATA + ")";
    
    public static final String RFC3339_SYSLOG_BASE = "^(" + RFC3339 + ") " + "(?:" + SYSLOGFACILITY + " )?" + "(" + USER
        + ") " + SYSLOGPROG + ": " + "(" + ANYDATA + ")";
}
