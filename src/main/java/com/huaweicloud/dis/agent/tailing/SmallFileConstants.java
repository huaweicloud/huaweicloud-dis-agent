...
public class SmallFileConstants extends Constants
{
    public static final String DESTINATION_KEY = "CustomFileStream";
    ...
    public static final int MAX_PUT_RECORDS_SIZE_BYTES = 128 * 1024 * 1024;
