...
public class MetricDatum implements Serializable, Cloneable
{
    ...
    public java.util.List<Dimension> getDimensions()
    {
        if (dimensions == null)
        {
            dimensions = new SdkInternalList<Dimension>();
        }
        return dimensions;
    }
    ...
    public MetricDatum withDimensions(Dimension... dimensions)
    {
        ...
        {
            setDimensions(new SdkInternalList<Dimension>(dimensions.length));
        }
     ...
     * </p>
     *
     * @param timestamp The time the metric data was received, expressed as the number of milliseconds since Jan 1, 1970
     *            00:00:00 UTC.
     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (other.getStorageResolution() == null ^ this.getStorageResolution() == null)
            return false;
        if (other.getStorageResolution() != null
            && other.getStorageResolution().equals(this.getStorageResolution()) == false)
            return false;
        return true;
    }
