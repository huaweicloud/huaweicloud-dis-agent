...
public final class ByteBufferInputStream extends InputStream
{
    ...
    /**
     * Create a new InputStream that is linked to the provided ByteBuffer. The buffer and this stream will share backing
     * data, position, limit, and mark, such that reading from this input stream will update the buffer position; care
     * should be taken to avoid concurrent reads and modifications, as ByteBuffers are not thread-safe.
     */
    ...
    /**
     * Closing a <code>ByteBufferInputStream</code> has no effect. The methods in this class can be called after the
     * stream has been closed without generating an <code>IOException</code>.
     * <p>
     */
    @Override
    public void close()
